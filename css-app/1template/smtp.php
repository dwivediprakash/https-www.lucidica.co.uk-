<?php
  ...
  $headers .= "To: sharp131996@gmail.com\r\n";
  $headers .= "From: admin@lavinka.com.ua";


function MailSmtp($reciever, $subject, $content, $headers, $debug = 0) {

  $smtp_server = 'mail.lucidica.com'; // адрес SMTP-сервера
  $smtp_port = 25; // порт SMTP-сервера
  $smtp_user = 'smtp@lucidica.com'; // Имя пользователя для авторизации на SMTP-сервере
  $smtp_password = 'ssad2123aaqq1S'; // Пароль для авторизации на SMTP-сервере
  $mail_from = 'smtp@lucidica.com'; // Ящик, с которого отправляется письмо
