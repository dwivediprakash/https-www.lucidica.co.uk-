...
if ( 'delete_schedule' == pb_backupbuddy::_POST( 'bulk_action' ) ) {
	...
	foreach ( pb_backupbuddy::_POST( 'items' ) as $id ) {
		...
		backupbuddy_api::deleteSchedule( $id, true );
...
// set earlier.
$schedule_definitions = false === ( $show_all_schedule_definitions || $force_show_all_schedule_definitions ) ? array_merge( $private_schedule_definitions, $this_schedule_definition ) : false;
