<?php
  /* Template Name: It Support London  */
  ...
  <section class="section page-header">
    <div class="spread image"
         style="background-position: center -200px;
    background-size: cover;
    background-repeat: no-repeat;background-image: url('https://www.lucidica.co.uk/wp-content/themes/lucidica/img/London-min.jpg')">
      <div class="wrapper section-header">
        <div class="header-block">
          <div class="header-bg"></div>
          <div class="header-text">
            <h1 class="page-title">IT Support London</h1>
      ...
      <div class="wrapper section-content">
        <div class="column two-col left">
          <p>As an IT company based in central London, it’s not surprising that we have a lot of clients based in the
            capital. Our lovely office in Shoreditch, London is where our engineers and team work to support businesses
            in London with their technical needs. We know that there are 1000s of IT support companies in London all
            offering the best solution, but we really believe that we provide an IT support contract like no other. Here
            are a few reasons why we are different to our competitors and why we are the best IT company in London.</p>

        </div>
        <div class="column two-col right">
          <p>A lot of IT companies in London offer similar services from hardware and software management to onsite and
            remote support making it hard to see the differences in IT companies. As our services are tailored to small
            to medium sized businesses, are IT services are created to allow and support the growth of your company. We
            offer consultation and advice based on your growth plan and have your businesses interest at heart the whole
            way. Got a big project coming up? We consider that and let you know if there’s anything we can do IT side to
            support that.</p>
  ...
  <div class="wrapper section-content" style="padding: 30px 0 0 0;">
    <div class="section-item">
      <h2 class="section-item-title">GET THE BEST LONDON IT SUPPORT</h2>
      <p>For small and medium sized businesses in London, Lucidica offers the best bespoke IT solutions. We spend time
        finding out exactly what is important to your business, what problems you’ve had in the past and your busiest
        times. We tailor your contract to suit those needs and ensure that all engineers in the business understand
        those as well.</p>
    </div>
  ...
  <section class="section" id="our-values">
    <div class="spread bg-light-blue txt-white">
      <div class="wrapper section-header" style="padding: 0 !important;">
        <div class="title-block" >
          <h2 class="section-title" style="margin: 0 auto;">Our Services</h2>
        </div>
      </div>

      <div class="wrapper section-content" style="padding: 0px 0 20px 0;">
  ...
  <div class="wrapper section-content" style="padding: 10px 0 0px 0;">
