...
<body>
	<div class="sec1" id="sec1">
		...
		<h1 class="title">
			<?php if ( $mail->send() ){
				echo 'Thank you for your application. We will be in touch shortly to let you know if we will be inviting you for interview. Because this is such an awesome job and Lucidica is a pretty popular place to work we have had loads of applications, so please allow 5 working days for a response';
			}
			else {
